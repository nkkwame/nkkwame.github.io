...
exports.getAllTags = exports.getMonths = exports.getYears = exports.getCategories = exports.blogPosts = void 0;
exports.blogPosts = [
    {
        id: 1,
...
var getCategories = function () {
    return Array.from(new Set(exports.blogPosts.map(function (post) { return post.category; })));
};
exports.getCategories = getCategories;
var getYears = function () {
    var years = exports.blogPosts.map(function (post) { return new Date(post.date).getFullYear(); });
...
var getMonths = function (year) {
    ...
    if (year) {
        var yearPosts = exports.blogPosts.filter(function (post) { return new Date(post.date).getFullYear() === year; });
        var months_1 = yearPosts.map(function (post) { return new Date(post.date).getMonth(); });
        return Array.from(new Set(months_1)).sort(function (a, b) { return b - a; }).map(function (month) { return monthNames[month]; });
    }
    var months = exports.blogPosts.map(function (post) { return new Date(post.date).getMonth(); });
    return Array.from(new Set(months)).sort(function (a, b) { return b - a; }).map(function (month) { return monthNames[month]; });
};
exports.getMonths = getMonths;
var getAllTags = function () {
    var allTags = exports.blogPosts.flatMap(function (post) { return post.tags || []; });
